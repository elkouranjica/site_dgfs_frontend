...
async function Actus(props) {
    ...
    return (
        <div id="actu" className="p-12 px-32 pt-0 flex flex-col gap-6">
            ...
            <div className="grid grid-cols-3 gap-14 my-12">
                {
                    data.results.map(
...
function Actu({title, resume, date, tags, image, id}) {
    return (
        <Link
            ...
            <div className="p-6 bg-neutral-100 flex flex-col gap-3">
                <p>{date} | {tags}</p>
