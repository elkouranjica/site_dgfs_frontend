...
function Header(props) {
    ...
    return (
        <header
            className={"relative bg-hero-gb bg-fixed h-[55vh] bg-no-repeat bg-center bg-cover bg-black bg-opacity-60 bg-blend-multiply flex items-center justify-center"}>
